  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      <div className="flex items-center gap-4">
        <Button variant="outline" onClick={() => router.push("/backtests")}>← Back</Button>
        <h1 className="text-4xl font-bold tracking-tight">Run New Backtest</h1>
      </div>
  ...
  "tsl_levels": [
    ...
    { "activation_pct": 2.0, "trail_pct": 1.0, "qty_pct": 50 }
        ...
        <CardFooter className="flex justify-end gap-2">
          <Button variant="ghost" onClick={() => router.push("/backtests")}>Cancel</Button>
